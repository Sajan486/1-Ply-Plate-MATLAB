function [TransCoord_Cent,TransCoord_Top,TransCoord_Btm,NumSourcePt_Trans] = DiscretizeTransducer(InnerR_Trans,OuterR_Trans,NumSourcePt_Trans,NumTrans,TransCoord_z,Rotation_Trans1,Rotation_Trans2,Dist_Intface2)
%%
...
for indice=1:NumSourcePt_Trans
    TransCoord_Cent{1}(:,indice) = [c1*coord{1}(1,indice)-s1*coord{1}(3,indice)  coord{1}(2,indice)  s1*coord{1}(1,indice)+c1*coord{1}(3,indice)];
    TransCoord_Top{1}(:,indice) = [c1*coord1{1}(1,indice)-s1*coord1{1}(3,indice) coord1{1}(2,indice) s1*coord1{1}(1,indice)+c1*coord1{1}(3,indice)];
    TransCoord_Btm{1}(:,indice) = [c1*coord2{1}(1,indice)-s1*coord2{1}(3,indice) coord2{1}(2,indice) s1*coord2{1}(1,indice)+c1*coord2{1}(3,indice)];
    
    TransCoord_Cent{2}(:,indice) = [c2*coord{2}(1,indice)-s2*coord{2}(3,indice)+(Dist_Intface2*s2)  coord{2}(2,indice)  s2*coord{2}(1,indice)+c2*coord{2}(3,indice)+(Dist_Intface2*(1-c2))];
    TransCoord_Top{2}(:,indice) = [c2*coord1{2}(1,indice)-s2*coord1{2}(3,indice)+((Dist_Intface2)*s2) coord1{2}(2,indice) s2*coord1{2}(1,indice)+c2*coord1{2}(3,indice)+(Dist_Intface2*(1-c2))];
    TransCoord_Btm{2}(:,indice) = [c2*coord2{2}(1,indice)-s2*coord2{2}(3,indice)+((Dist_Intface2)*s2) coord2{2}(2,indice) s2*coord2{2}(1,indice)+c2*coord2{2}(3,indice)+(Dist_Intface2*(1-c2))];
end